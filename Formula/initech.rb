class Initech < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nmelo/initech-releases/releases/download/v0.1.0/initech_darwin_arm64.tar.gz"
      sha256 "f5c7f0a5a006b2ede1a22db1b80b53c06a072eba0090c0f6fee64d06bd9df904"
    end
    on_intel do
      url "https://github.com/nmelo/initech-releases/releases/download/v0.1.0/initech_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/nmelo/initech-releases/releases/download/v0.1.0/initech_linux_arm64.tar.gz"
      sha256 "2b24b1c97088b2a454bd8677963141d4fe1512f7ec8dc64c75824679156b4b4b"
    end
    on_intel do
      url "https://github.com/nmelo/initech-releases/releases/download/v0.1.0/initech_linux_amd64.tar.gz"
